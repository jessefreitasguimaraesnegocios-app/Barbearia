...
const Shop = () => {
  ...
  const displayProducts = useMemo(() => {
    ...
    // Filtrar produtos: devem ter categoria (ou ser tratados como "produtos"), não ser rascunho, e corresponder à categoria selecionada
    return allProducts.filter(
      (product) => {
        const category = product.category || "produtos"; // Categoria padrão se não tiver
        return category !== "rascunho" && category === selectedCategory;
      }
    );
